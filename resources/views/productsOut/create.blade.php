                ...
                <div class="card-body">
                    <form action="{{ route('productsOut.store') }}" method="POST" enctype="multipart/form-data">                        
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control @error('date') is-invalid @enderror" name="tgl_keluar" value="{{ date('Y-m-d') }}" @readonly(true)>
                            ...
                            <input type="text" class="form-control @error('quantity') is-invalid @enderror" name="qty_keluar" value="{{ old('') }}" placeholder="Masukkan Stock Product">
